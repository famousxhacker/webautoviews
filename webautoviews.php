...
echo "
  ...
  / /\ \| | | | __/ _ \ \/ / | / __| | __/ _ \| '__|
 / ____ \ |_| | || (_) \  /  | \__ \ | || (_) | |   
/_/    \_\__,_|\__\___/ \/   |_|___/_|\__\___/|_| 

\n\n";
echo " ========================================================= \n ";
echo " \n";
echo "$merah Creator : Rohan Banekar \n";
echo "$merah Instagram : https://instagram.com/rohan_banekar \n";
echo "$kuning  \n";
echo " \n \n";
echo ' Website Link : ';
...
curl_setopt($ch, CURLOPT_REFERER, 'https://rohan-banekar.blogspot.com');
...
$code = $info['http_code'];
curl_close($ch);
echo "$hijau Success with the following IP & PORT:";
return $ip.":".$port." -> ".$code;
echo "--->\n\n";
